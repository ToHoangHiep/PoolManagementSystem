...
public class FeedbackDAO {
    ...
    public static List<Feedback> getAllFeedbacks_user(int userId) {
    ...
    public static List<Feedback> sortFeedback_user(
            int userId,
            Integer coachId,
            Integer courseId,
            String feedbackType,
    ...
    public static List<Feedback> getAllFeedbacks_admin() {
        List<Feedback> feedbacks = new ArrayList<>();
    ...
    public static List<Feedback> sortFeedbacks_admin(
            Integer coachId,
            Integer courseId,
            String feedbackType,
            String generalFeedbackType,
